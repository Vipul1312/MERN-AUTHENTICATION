...
const ResetPassword = () => {
  ...
  return (
    ...
    { !isEmailSent && 
         ...
         <h1 className='text-white text-2xl font-semibold text-center mb-5'>Reset Password</h1>
    ...
    { !isOtpSubmited && isEmailSent && 
        ...
        <h1 className='text-white text-2xl font-semibold text-center mb-5'>Reset Password OTP</h1>
    ...
    { isOtpSubmited && isEmailSent && 
      ...
      <form onSubmit={onSubmitNewPassword} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
         <h1 className='text-white text-2xl font-semibold text-center mb-5'>New Password</h1>
